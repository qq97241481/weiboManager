...
<div id="content">
  <div id="content-header">
    <div id="breadcrumb"><a href="#" title="Go to Home" class="tip-bottom"><i class="icon-home"></i> Home</a> <a href="#" class="current">微博图表统计</a></div>
    <h1>微博图表统计</h1>
  </div>
...
<script src="js/matrix.chart.js"></script> 
